...
public class PosixClient  extends FuseStubFS {
     ...
     */
    private ChatMessages.MessageWrapper sendRequest(
            ChatMessages.MessageWrapper request)
            throws IOException {
        ...
        ChatMessages.MessageWrapper respWrapper =
                ChatMessages.MessageWrapper.parseFrom(response);
    ...
    public int readdir(
        ...
        ChatMessages.MessageWrapper reqWrapper
