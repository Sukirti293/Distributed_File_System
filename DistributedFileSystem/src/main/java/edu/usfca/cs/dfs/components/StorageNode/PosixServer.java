...
import edu.usfca.cs.dfs.components.Client.PosixClient;
...
public class PosixServer extends SimpleChannelInboundHandler<ChatMessages.MessageWrapper> {
    ...
    public void channelRead0(
            ChannelHandlerContext ctx, ChatMessages.MessageWrapper msg) {
        ...
        if (msg.hasReaddirReq() == true) {
            ...
            ChatMessages.MessageWrapper wrapper
